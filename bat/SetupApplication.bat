...
:: Android packaging
set AND_CERT_NAME="AudioBlaster_Mobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AudioBlasterMobile.p12
...
set IOS_PROVISION=cert\AudioBlasterMobile.mobileprovision
...
set APP_ID=air.com.tkbz.AudioBlasterMobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AudioBlasterMobile
